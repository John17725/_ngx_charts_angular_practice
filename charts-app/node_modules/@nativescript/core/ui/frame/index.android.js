...
export class Frame extends FrameBase {
    ...
    _onAttachedToWindow() {
        ...
        if ((this._manager && this._manager.isDestroyed()) || !((_a = activity.getLifecycle) === null || _a === void 0 ? void 0 : _a.call(activity).getCurrentState().isAtLeast(androidx.lifecycle.Lifecycle.State.STARTED))) {
            return;
        }
